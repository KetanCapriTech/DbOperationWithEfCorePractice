        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrencyDescription = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Currencies",
                columns: new[] { "Id", "Country", "CurrencyDescription", "CurrencyName" },
                values: new object[,]
                {
                    { 1, "India", "Indian rupees", "INR" },
                    { 2, "USA", "American doller", "DOLLER" },
                    { 3, "European", "European eurp", "EURO" },
                    { 4, "JAPAN", "Japanees yen", "YEN" }
                });
